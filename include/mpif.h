...
! Types
        ...
        parameter (MPI_CHARACTER=29)
        parameter (MPI_LOGICAL=28)
        parameter (MPI_INTEGER=24)
        parameter (MPI_INTEGER1=31)
        parameter (MPI_INTEGER2=32)
        parameter (MPI_INTEGER4=33)
        parameter (MPI_INTEGER8=34)
        parameter (MPI_REAL=25)
        parameter (MPI_REAL4=36)
        parameter (MPI_REAL8=37)
        parameter (MPI_REAL16=38)
        parameter (MPI_DOUBLE_PRECISION=26)
        parameter (MPI_COMPLEX=27)
        parameter (MPI_COMPLEX8=27)
        parameter (MPI_COMPLEX16=30)
        parameter (MPI_DOUBLE_COMPLEX=30)
        parameter (MPI_2REAL=39)
        parameter (MPI_2DOUBLE_PRECISION=40)
        parameter (MPI_2INTEGER=41)
        parameter (MPI_UB=-1)
        parameter (MPI_LB=-2)
