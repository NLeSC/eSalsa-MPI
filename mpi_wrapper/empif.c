...
FORT_NAME( empi_init , EMPI_INIT ) ( int *ierr )
{
	// TODO!!!
}

FORT_NAME( empi_abort , EMPI_ABORT ) ( int *comm, int *errorcode , int *ierr )
{
	*ierr = EMPI_Abort(*comm, *errorcode);
}

FORT_NAME( empi_initialized , EMPI_INITIALIZED ) ( int *flag , int *ierr )
{
	*ierr = EMPI_Initialized(flag);
}

FORT_NAME( empi_finalize , EMPI_FINALIZE ) ( int *ierr )
{
	*ierr = EMPI_Finalize();
}

FORT_NAME( empi_finalized , EMPI_FINALIZED ) ( int *flag , int *ierr )
{
...
FORT_NAME( empi_add_error_string , EMPI_ADD_ERROR_STRING ) ( int errorcode, char *string , int *ierr )
{
}
...
FORT_NAME( empi_allgather , EMPI_ALLGATHER ) ( void *sendbuf, int sendcount, EMPI_Datatype sendtype, void *recvbuf, int recvcount, EMPI_Datatype recvtype, EMPI_Comm comm , int *ierr )
{
}

FORT_NAME( empi_allgatherv , EMPI_ALLGATHERV ) ( void *sendbuf, int sendcount, EMPI_Datatype sendtype, void *recvbuf, int *recvcounts, int *displs, EMPI_Datatype recvtype, EMPI_Comm comm , int *ierr )
{
}
...
FORT_NAME( empi_allreduce , EMPI_ALLREDUCE ) ( void *sendbuf, void *recvbuf, int count, EMPI_Datatype datatype, EMPI_Op op, EMPI_Comm comm , int *ierr )
{
}

FORT_NAME( empi_alltoall , EMPI_ALLTOALL ) ( void *sendbuf, int sendcount, EMPI_Datatype sendtype, void *recvbuf, int recvcount, EMPI_Datatype recvtype, EMPI_Comm comm , int *ierr )
{
}

FORT_NAME( empi_alltoallv , EMPI_ALLTOALLV ) ( void *sendbuf, int *sendcnts, int *sdispls, EMPI_Datatype sendtype, void *recvbuf, int *recvcnts, int *rdispls, EMPI_Datatype recvtype, EMPI_Comm comm , int *ierr )
{
}

FORT_NAME( empi_alltoallw , EMPI_ALLTOALLW ) ( void *sendbuf, int *sendcnts, int *sdispls, EMPI_Datatype *sendtypes, void *recvbuf, int *recvcnts, int *rdispls, EMPI_Datatype *recvtypes, EMPI_Comm comm , int *ierr )
{
}
...
FORT_NAME( empi_barrier , EMPI_BARRIER ) ( EMPI_Comm comm , int *ierr )
{
}

FORT_NAME( empi_bcast , EMPI_BCAST ) ( void *buffer, int count, EMPI_Datatype datatype, int root, EMPI_Comm comm , int *ierr )
{
}
...
FORT_NAME( empi_comm_create , EMPI_COMM_CREATE ) ( EMPI_Comm comm, EMPI_Group g, EMPI_Comm *newcomm , int *ierr )
{
}
...
FORT_NAME( empi_comm_dup , EMPI_COMM_DUP ) ( EMPI_Comm comm, EMPI_Comm *newcomm , int *ierr )
{
}

FORT_NAME( empi_comm_free , EMPI_COMM_FREE ) ( EMPI_Comm *comm , int *ierr )
{
}
...
FORT_NAME( empi_comm_group , EMPI_COMM_GROUP ) ( EMPI_Comm comm, EMPI_Group *g , int *ierr )
{
}
...
FORT_NAME( empi_comm_rank , EMPI_COMM_RANK ) ( EMPI_Comm comm, int *rank , int *ierr )
{
}
...
FORT_NAME( empi_comm_size , EMPI_COMM_SIZE ) ( EMPI_Comm comm, int *size , int *ierr )
{
}
...
FORT_NAME( empi_comm_split , EMPI_COMM_SPLIT ) ( EMPI_Comm comm, int color, int key, EMPI_Comm *newcomm , int *ierr )
{
}
...
FORT_NAME( empi_error_string , EMPI_ERROR_STRING ) ( int errorcode, char *string, int *resultlen , int *ierr )
{
}
...
FORT_NAME( empi_file_close , EMPI_FILE_CLOSE ) ( EMPI_File *mpi_fh , int *ierr )
{
}
...
FORT_NAME( empi_file_open , EMPI_FILE_OPEN ) ( EMPI_Comm comm, char *filename, int amode, EMPI_Info info, EMPI_File *fh , int *ierr )
{
}
...
FORT_NAME( empi_file_read_all , EMPI_FILE_READ_ALL ) ( EMPI_File EMPI_fh, void *buf, int count, EMPI_Datatype datatype, EMPI_Status *status , int *ierr )
{
}
...
FORT_NAME( empi_file_read_at , EMPI_FILE_READ_AT ) ( EMPI_File EMPI_fh, EMPI_Offset offset, void *buf, int count, EMPI_Datatype datatype, EMPI_Status *status , int *ierr )
{
}
...
FORT_NAME( empi_file_set_view , EMPI_FILE_SET_VIEW ) ( EMPI_File EMPI_fh, EMPI_Offset disp, EMPI_Datatype etype, EMPI_Datatype filetype, char *datarep, EMPI_Info info , int *ierr )
{
}
...
FORT_NAME( empi_file_write_all , EMPI_FILE_WRITE_ALL ) ( EMPI_File EMPI_fh, void *buf, int count, EMPI_Datatype datatype, EMPI_Status *status , int *ierr )
{
}
...
FORT_NAME( empi_file_write_at , EMPI_FILE_WRITE_AT ) ( EMPI_File EMPI_fh, EMPI_Offset offset, void *buf, int count, EMPI_Datatype datatype, EMPI_Status *status , int *ierr )
{
}
...
FORT_NAME( empi_gather , EMPI_GATHER ) ( void *sendbuf, int sendcnt, EMPI_Datatype sendtype, void *recvbuf, int recvcnt, EMPI_Datatype recvtype, int root, EMPI_Comm comm , int *ierr )
{
}

FORT_NAME( empi_gatherv , EMPI_GATHERV ) ( void *sendbuf, int sendcnt, EMPI_Datatype sendtype, void *recvbuf, int *recvcnts, int *displs, EMPI_Datatype recvtype, int root, EMPI_Comm comm , int *ierr )
{
}
...
FORT_NAME( empi_get_processor_name , EMPI_GET_PROCESSOR_NAME ) ( char *name, int *resultlen , int *ierr )
{
}
...
FORT_NAME( empi_group_incl , EMPI_GROUP_INCL ) ( EMPI_Group g, int n, int *ranks, EMPI_Group *newgroup , int *ierr )
{
}
...
FORT_NAME( empi_group_range_excl , EMPI_GROUP_RANGE_EXCL ) ( EMPI_Group g, int n, int ranges[][3], EMPI_Group *newgroup , int *ierr )
{
}

FORT_NAME( empi_group_range_incl , EMPI_GROUP_RANGE_INCL ) ( EMPI_Group g, int n, int ranges[][3], EMPI_Group *newgroup , int *ierr )
{
}
...
FORT_NAME( empi_group_translate_ranks , EMPI_GROUP_TRANSLATE_RANKS ) ( EMPI_Group group1, int n, int *ranks1, EMPI_Group group2, int *ranks2 , int *ierr )
{
}

FORT_NAME( empi_group_union , EMPI_GROUP_UNION ) ( EMPI_Group group1, EMPI_Group group2, EMPI_Group *newgroup , int *ierr )
{
}

FORT_NAME( empi_ibsend , EMPI_IBSEND ) ( void *buf, int count, EMPI_Datatype datatype, int dest, int tag, EMPI_Comm comm, EMPI_Request *r , int *ierr )
{
}

FORT_NAME( empi_info_create , EMPI_INFO_CREATE ) ( EMPI_Info *info , int *ierr )
{
}

FORT_NAME( empi_info_delete , EMPI_INFO_DELETE ) ( EMPI_Info info, char *key , int *ierr )
{
}
...
FORT_NAME( empi_info_free , EMPI_INFO_FREE ) ( EMPI_Info *info , int *ierr )
{
}
...
FORT_NAME( empi_info_set , EMPI_INFO_SET ) ( EMPI_Info info, char *key, char *value , int *ierr )
{
}
...
FORT_NAME( empi_intercomm_create , EMPI_INTERCOMM_CREATE ) ( EMPI_Comm local_comm, int local_leader, EMPI_Comm peer_comm, int remote_leader, int tag, EMPI_Comm *newintercomm , int *ierr )
{
}

FORT_NAME( empi_intercomm_merge , EMPI_INTERCOMM_MERGE ) ( EMPI_Comm intercomm, int high, EMPI_Comm *newintracomm , int *ierr )
{
}
...
FORT_NAME( empi_irecv , EMPI_IRECV ) ( void *buf, int count, EMPI_Datatype datatype, int source, int tag, EMPI_Comm comm, EMPI_Request *r , int *ierr )
{
}

FORT_NAME( empi_irsend , EMPI_IRSEND ) ( void *buf, int count, EMPI_Datatype datatype, int dest, int tag, EMPI_Comm comm, EMPI_Request *r , int *ierr )
{
}

FORT_NAME( empi_isend , EMPI_ISEND ) ( void *buf, int count, EMPI_Datatype datatype, int dest, int tag, EMPI_Comm comm, EMPI_Request *r , int *ierr )
{
}
...
FORT_NAME( empi_recv , EMPI_RECV ) ( void *buf, int count, EMPI_Datatype datatype, int source, int tag, EMPI_Comm comm, EMPI_Status *status , int *ierr )
{
}
...
FORT_NAME( empi_reduce , EMPI_REDUCE ) ( void *sendbuf, void *recvbuf, int count, EMPI_Datatype datatype, EMPI_Op op, int root, EMPI_Comm comm , int *ierr )
{
}
...
FORT_NAME( empi_request_free , EMPI_REQUEST_FREE ) ( EMPI_Request *r , int *ierr )
{
}
...
FORT_NAME( empi_rsend , EMPI_RSEND ) ( void *buf, int count, EMPI_Datatype datatype, int dest, int tag, EMPI_Comm comm , int *ierr )
{
}
...
FORT_NAME( empi_scatter , EMPI_SCATTER ) ( void *sendbuf, int sendcnt, EMPI_Datatype sendtype, void *recvbuf, int recvcnt, EMPI_Datatype recvtype, int root, EMPI_Comm comm , int *ierr )
{
}

FORT_NAME( empi_scatterv , EMPI_SCATTERV ) ( void *sendbuf, int *sendcnts, int *displs, EMPI_Datatype sendtype, void *recvbuf, int recvcnt, EMPI_Datatype recvtype, int root, EMPI_Comm comm , int *ierr )
{
}

FORT_NAME( empi_send , EMPI_SEND ) ( void *buf, int count, EMPI_Datatype datatype, int dest, int tag, EMPI_Comm comm , int *ierr )
{
}
...
FORT_NAME( empi_sendrecv , EMPI_SENDRECV ) ( void *sendbuf, int sendcount, EMPI_Datatype sendtype, int dest, int sendtag, void *recvbuf, int recvcount, EMPI_Datatype recvtype, int source, int recvtag, EMPI_Comm comm, EMPI_Status *status , int *ierr )
{
}
...
FORT_NAME( empi_ssend , EMPI_SSEND ) ( void *buf, int count, EMPI_Datatype datatype, int dest, int tag, EMPI_Comm comm , int *ierr )
{
}
...
FORT_NAME( empi_type_commit , EMPI_TYPE_COMMIT ) ( EMPI_Datatype *datatype , int *ierr )
{
}

FORT_NAME( empi_type_contiguous , EMPI_TYPE_CONTIGUOUS ) ( int count, EMPI_Datatype old_type, EMPI_Datatype *new_type_p , int *ierr )
{
}
...
FORT_NAME( empi_type_create_indexed_block , EMPI_TYPE_CREATE_INDEXED_BLOCK ) ( int count, int blocklength, int array_of_displacements[], EMPI_Datatype oldtype, EMPI_Datatype *newtype , int *ierr )
{
}
...
FORT_NAME( empi_type_free , EMPI_TYPE_FREE ) ( EMPI_Datatype *datatype , int *ierr )
{
}
...
FORT_NAME( empi_type_get_envelope , EMPI_TYPE_GET_ENVELOPE ) ( EMPI_Datatype datatype, int *num_integers, int *num_addresses, int *num_datatypes, int *combiner , int *ierr )
{
}
...
FORT_NAME( empi_waitall , EMPI_WAITALL ) ( int count, EMPI_Request array_of_requests[], EMPI_Status array_of_statuses[] , int *ierr )
{
}

FORT_NAME( empi_waitany , EMPI_WAITANY ) ( int count, EMPI_Request array_of_requests[], int *index, EMPI_Status *status , int *ierr )
{
}

FORT_NAME( empi_wait , EMPI_WAIT ) ( EMPI_Request *r, EMPI_Status *status , int *ierr )
{
}
